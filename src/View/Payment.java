...
public class Payment extends javax.swing.JPanel {
    ...
    private final String tableName = "Chi tiết thanh toán";

    private final TextField[] textFields = new TextField[]{
        new TextField("ID đơn đặt", "BookingID", "Number"),
        new TextField("Ngày thanh toán", "PaymentDate", "Date"),
        new TextField("Phương thức thanh toán", "Method", "String")
    };
...
//        HIỂN THỊ DỮ LIỆU TRON DATABASE
        List<Map<String, Object>> results = PaymentController.getAll();
...
//        SET DATA MẶC ĐỊNH
        ...
        if (result == JOptionPane.OK_OPTION) {
            ...
            PaymentController.update(id, data);
            showDataTable();
        }
