...
public class User extends javax.swing.JPanel {
    ...
    private final TextField[] textFields = new TextField[]{
        new TextField("Tên người dùng", "FullName", "String"),
        new TextField("Tài khoản", "UserName", "String"),
        new TextField("Mật khẩu", "Password", "String"),
        new TextField("Quyền", "Permission", "String"),};
...
//        HIỂN THỊ DỮ LIỆU TRON DATABASE
        List<Map<String, Object>> results = UserController.getAll();
    ...
    private void editButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editButtonActionPerformed
        ...
        panel.remove(panel.getTextField(3));
...
//        SET DATA MẶC ĐỊNH
        ...
        comboBox.setSelectedItem(table.getModel().getValueAt(row, 3).toString());
